...
const float drift = 1.2;      // Your hardware drift correction
...
void loop() {
  ...
  if (!leftOnTape && !rightOnTape) {
    ...
    turnLeft(turnSpeed);
    delay(70); // Small fixed duration to clear the tape edge
  } 
  ...
  delay(30); // Fast polling for responsiveness
}
